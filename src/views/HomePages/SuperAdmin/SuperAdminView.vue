...
import { checkingRequestApi, GetPostsByIdApi, confirmJunkApi } from '@/api/post';
...
const fetchPosts = async () => {
  try {
    const codeStr = selectedcode.join(',');
    const response = await GetPostsByIdApi(currentPage.value, globalStore.userId, codeStr.value);
